...
gradSurgery = GradSurgery(sharedLayerParameters)#
...
optimizer_taskLayer = optim.Adam(taskLayerParameters, lr=args.lr, weight_decay=0.0000001)#,#0.0000005
...
for epoch in range(args.epochs):
	...
	for step, batch in enumerate(tqdm(train_loader)):
		...
		weight_buy = model.weight_buy.cuda()
		weight_click = model.weight_click.cuda()
		weight_fav = model.weight_fav.cuda()
		...
		gradSurgery.step([loss_buy, loss_fav, loss_click, loss_cart])
	...
	print(weight_buy, weight_click, weight_fav)
